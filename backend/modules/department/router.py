...
from .service import create_department, get_department, get_departments, update_department, delete_department, get_db
...
async def create_department_info(department: DepartmentCreate, db: Session = Depends(get_db)):
    """创建部门"""
...
async def update_department_info(department_id: int, department_update: DepartmentUpdate, db: Session = Depends(get_db)):
    """更新部门信息"""

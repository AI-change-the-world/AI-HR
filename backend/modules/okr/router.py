...
from .service import create_okr, get_okr, get_okrs, update_okr, delete_okr, get_db
...
async def update_okr_info(okr_id: int, okr_update: OKRUpdate, db: Session = Depends(get_db)):
    """更新OKR信息"""

...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -400437944;
...
fn wire__crate__api__simple__beep_impl(
...
fn wire__crate__api__auth_api__decrypt_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_secret_str = <String>::sse_decode(&mut deserializer);
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::auth_api::decrypt(api_secret_str))?;
                Ok(output_ok)
            })())
        },
    )
...
impl SseDecode for crate::auth::auth_ai::AiInfo {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
...
impl SseDecode for Option<crate::auth::auth_ai::AiInfo> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        if (<bool>::sse_decode(deserializer)) {
            return Some(<crate::auth::auth_ai::AiInfo>::sse_decode(deserializer));
        } else {
            return None;
        }
    }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire__crate__api__salary_api__get_caculate_result_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__simple__beep_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__auth_api__decrypt_impl(ptr, rust_vec_len, data_len),
...
impl flutter_rust_bridge::IntoDart for crate::auth::auth_ai::AiInfo {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::auth::auth_ai::AiInfo {}
impl flutter_rust_bridge::IntoIntoDart<crate::auth::auth_ai::AiInfo>
    for crate::auth::auth_ai::AiInfo
{
    fn into_into_dart(self) -> crate::auth::auth_ai::AiInfo {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::auth::auth_ai::AiInfo {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
...
impl SseEncode for Option<crate::auth::auth_ai::AiInfo> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <bool>::sse_encode(self.is_some(), serializer);
        if let Some(value) = self {
            <crate::auth::auth_ai::AiInfo>::sse_encode(value, serializer);
        }
    }
}
